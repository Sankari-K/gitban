...
def tag_create(repo, name, ref, create_tag_object=False):
    ...
    if create_tag_object:
        ...
        tag.kvlm[b'tagger'] = b'Gitban <gitban@example.com>'
        # …and a tag message!
        tag.kvlm[None] = b"A tag generated by gitban, which won't let you customize the message!"
...
def index_read(repo):
    ...
    assert version == 2, "gitban only supports index file version 2"
